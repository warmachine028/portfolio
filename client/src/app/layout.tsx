...
import { Montserrat, Raleway, Urbanist, Source_Code_Pro } from 'next/font/google'
...
*/
const secondary: FontConfig | undefined = Raleway({
	variable: '--font-secondary',
	subsets: ['latin'],
	display: 'swap'
})

const tertiary: FontConfig | undefined = Urbanist({
